...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    tallerAuthUserSubject.add(
      TallerAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<TallerAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  TallerAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = TallerAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    tallerAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
